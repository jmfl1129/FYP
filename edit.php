...
// reference from https://www.php.net/manual/en/function.rmdir.php#117354
 ...
 if (is_dir('/home/www/htdocs/img_tmp/' . $_COOKIE['name'])){
  ...
  $q = 'SELECT * FROM photos WHERE phid = :phid;';
...
<div id="wrap">
	...
	<div id="content">
		...
		<form method="POST" action="download.php" class="form-signin" target="_blank" id="dn">
		
		</form>

		<button form="dn" type="submit" name="download" id="sel_download" style="opacity: 0; position: absolute; left: -100vw;" ></button>
		...
		<button form="dn" type="submit" name="delete" id="sel_delete" style="opacity: 0; position: absolute; left: -100vw;" ></button>
		<label for="sel_delete" class="button" style="left: 90% !important; top: 88% !important; width: 150px !important; height: 50px !important;">
				  <h1 class="onoff" style="font-size: 1.5em !important; margin: 7px 0 0 !important;">
					<span class="first">D</span><span>e</span><span class="first">lete</span>
				  </h1>
		</label>
		...
		<a href="all_delete.php" class="button" style="left: 20% !important; top: 88% !important; width: 200px !important; height: 50px !important;" target="_blank">
				  <h1 class="onoff" style="font-size: 1.5em !important; margin: 7px 0 0 !important;">
					<span class="first">D</span><span>e</span><span class="first">lete</span><span></span><span class="first"> ALL</span>
				  </h1>
		</a>
